...
public class CustomToast implements IToast {
    ...
    public CustomToast(Context context) {
        ...
        mParams.windowAnimations = android.R.style.Animation_Toast;/* R.style.CustomToastStyle;*/
    ...
    private static CustomToast priToast;
    ...
    private static void activeQueue() {
        ...
        if (toast == null) {
            ...
            if (priToast != null) {
                mHandler.removeCallbacks(priToast.mHide);
                mHandler.removeCallbacks(mActivite);
                priToast.handleHide();
            }
